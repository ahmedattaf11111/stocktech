            ...
            <div class="row">
              ...
              <div class="col-lg-12 mb-2">
                <div class="form-group">
                  ...
                  <input
                    :placeholder="$t('TYPE_AUTHOR_NAME')"
                    type="text"
                    class="form-control"
                    v-model="v$.author.$model"
                    :class="{
                      'is-invalid': v$.author.$error,
                    }"
                  />
                  <div class="invalid-feedback">
                    <div v-for="error in v$.author.$errors" :key="error">
                      {{ $t("AUTHOR_NAME") + " " + $t(error.$validator) }}
                    </div>
                    <div v-if="!v$.author.$invalid">
                      {{ $t("AUTHOR_NAME") + " " + $t("EXIST") }}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12 mb-2">
                <div class="form-group">
                  ...
                  <textarea
                    rows="3"
                    :placeholder="$t('TYPE_BLOG_DESCRIPTION')"
                    type="text"
                    class="form-control"
                    :class="{
            ...
            <div class="row">
              <div class="col-lg-12 mb-4">
                <Image
                  :id="1"
                  title="BLOG_IMAGE"
                  subTitle="CHOOSE_BLOG_THUMBNAIL"
      ...
      <div class="col-lg-3 order-lg-2 order-1">
        ...
        >
          <div class="information">
            <div class="title">{{ $t("BLOG_INFORMATION") }}</div>
            <ul>
              <a
...
import blogClient from "../../../http-clients/admin/blog-client";
