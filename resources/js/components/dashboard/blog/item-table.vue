      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_BLOG") }}</div>
            <form>
              <div class="row">
                ...
                <div class="col-lg-12">
                  <Image
                    :id="1"
                    title="BLOG_IMAGE"
                    subTitle="SELECT_BLOG_THUMBNAIL"
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      blogClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      blogClient.getAllItems().then((res) => {
        let data = res.data;
