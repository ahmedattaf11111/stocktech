          ...
          <table class="table" id="printMe">
            ...
            <tbody v-if="items.length">
              <tr v-for="(item, index) in items" :key="item.id">
                ...
                <td>{{ item.name }}</td>
                <td>
                  <span class="normal" v-if="item.contest_type">
                    {{ item.contest_type.name }}
                  </span>
                ...
                <td>
                  <span class="normal">{{ item.date }}</span>
                </td>
                <td class="actions-cell">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                      <router-link
                        class="dropdown-item"
                        :to="`/admin/contests-form/${item.id}`"
                        >{{ $t("EDIT") }}</router-link
                      >
                      <a
...
export default {
  ...
  setup() {
    ...
    function downloadExcelFile() {
      contestClient.getAllItems().then((res) => {
        let data = res.data;
