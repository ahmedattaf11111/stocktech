      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
                    ...
                    <td class="actions-cell">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-left">
                          <router-link
                            class="dropdown-item"
                            :to="`/admin/platform-employees-form/${item.id}`"
                            >{{ $t("EDIT") }}</router-link
                          >
                          <a
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_EMPLOYEE") }}</div>
            <form>
              <div class="row">
...
import employeePlatformClient from "../../../http-clients/admin/employee-platform-client";
import Paginate from "vuejs-paginate-next";
import exportFromJSON from "export-from-json";
import DeleteConfirmation from "../../../shared/components/delete-confirmation.vue";
import { inject, onMounted, provide, reactive, toRefs } from "vue-demi";
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      employeePlatformClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      employeePlatformClient.getAllItems().then((res) => {
        let data = res.data;
