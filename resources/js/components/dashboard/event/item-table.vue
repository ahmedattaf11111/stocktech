      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_EVENT") }}</div>
            <form>
              <div class="row">
                ...
                <div class="col-lg-12">
                  <Image
                    :id="1"
                    title="EVENT_IMAGE"
                    subTitle="CHOOSE_EVENT_THUMBNAIL"
      ...
      >
        ...
        >
          <div class="information">
            <div class="title">{{ $t("EVENT_INFORMATION") }}</div>
            <ul>
...
import eventClient from "../../../http-clients/admin/event-client";
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      eventClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      eventClient.getAllItems().then((res) => {
        let data = res.data;
