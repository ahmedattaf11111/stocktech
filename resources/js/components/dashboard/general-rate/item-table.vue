      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12 text-right">
          <router-link
            ...
            :to="`/admin/general-rates-form/create`"
          >
            <svg
      ...
      <div class="table-container">
        ...
        <div class="table-responsive">
          <table class="table" id="printMe">
            <thead>
              <tr>
                <th style="width: 6%" scope="col">{{ $t("S/L") }}</th>
                ...
                <th style="width: 14%" class="actions-header" scope="col">
                  {{ $t("ACTIONS") }}
                </th>
              </tr>
            </thead>
            <tbody v-if="items.length">
              <tr v-for="(item, index) in items" :key="item.id">
                ...
                <td>
                  <span class="normal" v-if="item.employee">
                    {{ item.employee.name }}
                  </span>
                ...
                <td>
                  <span class="normal" v-if="item.student">
                    {{ item.student.name }}
                  </span>
                  <span v-else class="chip">
                    {{ $t("N/A") }}
                ...
                <td class="actions-cell">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                      <router-link
                        class="dropdown-item"
                        :to="`/admin/general-rates-form/${item.id}`"
                        >{{ $t("EDIT") }}</router-link
                      >
                      <a
            ...
            <tbody v-else>
              <tr>
                <td class="no-result" colspan="10">{{ $t("No results") }}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default {
  ...
  setup() {
    ...
    function downloadExcelFile() {
      generalRateClient.getAllItems().then((res) => {
        let data = res.data;
