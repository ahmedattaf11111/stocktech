            ...
            <div class="row">
              ...
              <div class="col-lg-12 mb-2">
                <div class="form-group">
                  ...
                  <input
                    :placeholder="$t('TYPE_GURADIAN_JOB')"
                    type="text"
                    class="form-control"
                    v-model="job"
                  />
        ...
        >
          <div class="create-item">
            <div class="title mb-4">
              {{ $t("Guardian and national id images") }}
            </div>
            <div class="row">
              <div class="col-lg-12 mb-4">
                <Image
                  ...
                  subTitle="CHOOSE_GUARDIAN_IMAGE_THUMBNAIL"
          ...
          <div class="col-lg-6">
            <div class="form-container bg-white border border-radius-4 mb-30">
              <div class="create-item">
                ...
                <div class="form-group">
                  <input
                    :placeholder="$t('TYPE_GUARDIAN_ADDRESS')"
                    type="text"
                    class="form-control"
                    v-model="address"
                  />
...
export default {
  ...
  setup(props, context) {
    ...
    onMounted(() => {
      guardianClient.getItem(route.params.id).then((res) => {
