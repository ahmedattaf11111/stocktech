<template>
  <div class="__notifications-container">
        ...
        <div class="modal-content">
          <form @submit.prevent="">
            <div class="modal-body">
              ...
              <div v-if="destination == 'employee'" class="form-group">
                <Multiselect
              ...
              <div v-if="destination == 'student'" class="form-group">
                <Multiselect
                  mode="tags"
            ...
            <tbody v-if="items.length">
              <tr v-for="(item, index) in items" :key="item.id">
                ...
                <td>
                  <template
                    v-if="
                      item.destination == 'employee' && item.employees.length
                    "
                  >
                    <span
                ...
                <td>
                  <template
                    v-if="item.destination == 'student' && item.students.length"
                  >
                    <span
...
import notificationClient from "../../../http-clients/admin/notification-client";
...
export default {
  ...
  setup() {
    const data = reactive({
      ...
      status: "",
      destinations: [
        { value: "all_users", name_ar: "كل المستخدمين", name_en: "All Users" },
        {
          value: "all_employees",
          name_ar: "كل الموظفين",
        ...
        { value: "student", name_ar: "طالب", name_en: "Student" },
        { value: "employee", name_ar: "موظف", name_en: "Employee" },
      ],

      types: [
        { value: "event", name_ar: "حدث", name_en: "Event" },
        { value: "contest", name_ar: "مسابقة", name_en: "Contest" },
        { value: "test", name_ar: "اختبار", name_en: "Test" },
      ],
      attendances: [
    ...
    created();
    onMounted(() => {
      notificationClient.getEmployees().then((res) => {
        data.employees = res.data;
      });
      notificationClient.getStudents().then((res) => {
        data.students = res.data;
      });
    });
    //Methods
    function disableForm() {
      if (form.destination == "employee") {
        return (
          !form.destination ||
          !form.subject ||
          !form.employee_id ||
      ...
      if (form.destination == "student") {
        return (
          !form.destination || !form.subject || !form.student_id || !form.message
        );
      }
      return (
        !form.destination ||
    ...
    function getSessions(id) {
      if (!id) return;
      notificationClient.getSessions(id).then((res) => {
    ...
    function downloadExcelFile() {
      notificationClient.getAllItems().then((res) => {
        let data = res.data;
