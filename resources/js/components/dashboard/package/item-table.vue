      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
                    ...
                    <td class="actions-cell">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-left">
                          <router-link
                            class="dropdown-item"
                            :to="`/admin/packages-form/${item.id}`"
                            >{{ $t("EDIT") }}</router-link
                          >
                          <a
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_PACKAGE") }}</div>
            <form>
              <div class="row">
                <div class="col-lg-12 mb-3">
                  <div class="form-group">
                    ...
                    <input
                      :placeholder="$t('TYPE_PACKAGE_NAME')"
                      type="text"
                      class="form-control"
      ...
      >
        ...
        >
          <div class="information">
            <div class="title">{{ $t("PACKAGE_INFORMATION") }}</div>
            <ul>
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      packageClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      packageClient.getAllItems().then((res) => {
        let data = res.data;
