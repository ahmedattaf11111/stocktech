    ...
    <div class="page-header border" style="margin-top: 10px">
      <div class="row">
        <div class="col-md-6 col-sm-12">
          <div class="title">
            {{ $t("Best Students Statement") }}
            <span style="color: #a5a5a5; font-size: 10px"
              >({{ $t("according_to_general_rate") }})</span
            >
          </div>
        </div>
      </div>
          ...
          <table class="table" id="printMe">
            ...
            <tbody v-if="items.length">
              <tr v-for="(item, index) in items" :key="item.id">
                ...
                <td>
                  <div class="img-name">
                    <img
                      class="item-image"
                      :src="
                        item.student.media_manager
                          ? `/uploads/${item.student.media_manager.hash_name}`
                ...
                <td>
                  <span v-if="item.student.guardian">
...
export default {
  ...
  setup() {
    ...
    function getBestStudentsReport() {
      reportClient
        .getBestStudentsReport(data.limit)
