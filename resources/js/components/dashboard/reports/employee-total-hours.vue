...
export default {
  ...
  setup() {
    ...
    function getTotalHoursReport() {
      reportClient
        .getTotalHoursReport(data.start, data.end, data.employee_id)
        .then((res) => (data.items = [res.data]));
    }
    function searchItems() {
      if (!data.start || !data.end || !data.employee_id) return;
