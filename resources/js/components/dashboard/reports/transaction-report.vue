...
import reportClient from "../../../http-clients/admin/report-client";
...
export default {
  ...
  setup() {
    ...
    created();
    onMounted(() => {
      reportClient.getAccountItems().then((res) => {
    ...
    function getSessions(id) {
      if (!id) return;
      reportClient.getSessions(id).then((res) => {
    ...
    function downloadExcelFile() {
      reportClient.getAllItems().then((res) => {
        let data = res.data;
