        ...
        >
          <div class="profile-photo">
            ...
            <img
              class="avatar-photo"
              :src="
                currentStudent && currentStudent.media_manager
                  ? `/uploads/${currentStudent.media_manager.hash_name}`
          ...
          <div class="profile-info">
            <ul class="mt-3">
              ...
              <li>
                <span>{{ $t("PHONE") }}:</span>
                {{
                  currentStudent && currentStudent.phone
              ...
              <li>
                <span>{{ $t("LEVEL") }}:</span>
                {{
                  currentStudent && currentStudent.level
              ...
              <li>
                ...
                {{
                  currentStudent && currentStudent.guardian
...
export default {
  ...
  setup(props, context) {
    ...
    onMounted(() => {
      profileClient.getStudents().then((res) => (data.students = res.data));
    });
    //Methods
    function getRates() {
      profileClient
