      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
                    ...
                    <td class="actions-cell">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-left">
                          <router-link
                            class="dropdown-item"
                            :to="`/admin/supervisor-form/${item.id}`"
                            >{{ $t("EDIT") }}</router-link
                          >
                          <a
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_SUPERVISOR") }}</div>
            <form>
              <div class="row">
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      supervisorClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      supervisorClient.getAllItems().then((res) => {
        let data = res.data;
