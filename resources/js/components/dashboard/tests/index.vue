            ...
            <div class="modal-body">
              ...
              <div>
                ...
                <button
                  @click="storeSession"
                  :disabled="
                    !start || !end || !employee_id || !name || !test_type_id
                  "
...
import testClient from "../../../http-clients/admin/test-client";
...
export default {
  ...
  setup(props, context) {
    ...
    onMounted(() => {
      getTests();
      testClient.getEmployees().then((res) => {
        data.employees = res.data;
      });
      testClient.getTestTypes().then((res) => {
        data.testTypes = res.data;
      });
    });
    //Methods
    function getTests() {
      testClient.getItems().then((res) => {
