  ...
  <div class="dz-size" data-dz-size></div>
	...
	new Vue({
		...
		data: {
			loading: false,
			id: @json($id),
			service_title: "{{translate($dictionaries, 'service_title',$service_title, 'About', $id)}}",
			service_content: "{{translate($dictionaries, 'service_content',$service_content,'About', $id)}}",
			images: @json($images),
			experience_one: "{{translate($dictionaries, 'experience_one',$experience_one,'About', $id)}}",
			experience_one_rate: "{{translate($dictionaries, 'experience_one_rate',$experience_one_rate,'About', $id)}}",
			experience_tow: "{{translate($dictionaries, 'experience_tow',$experience_tow,'About', $id)}}",
			experience_tow_rate: "{{translate($dictionaries, 'experience_tow_rate',$experience_tow_rate,'About', $id)}}",
			experience_main_content: "{{translate($dictionaries, 'experience_main_content',$experience_main_content,'About', $id)}}",
			experience_second_content: "{{translate($dictionaries, 'experience_second_content',$experience_second_content,'About', $id)}}",
			experience_number: "{{translate($dictionaries, 'experience_number',$experience_number,'About', $id)}}",
			experience_number_text: "{{translate($dictionaries, 'experience_number_text',$experience_number_text,'About', $id)}}",
		},
		methods: {
			save() {
