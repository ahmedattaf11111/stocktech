...
<div id="smooth-content">
	...
	<main class="main-bg">
		...
		<header class="page-header bg-img section-padding" data-background="assets/imgs/header/bg1.jpg" data-overlay-dark="9">
			<div class="container pt-100">
				<div class="text-center">
					<h1>{{__('general.Blogs')}}</h1>
					<div class="mt-15">
						<a href="/web/home">{{__('general.Home')}}</a>
						<span class="padding-rl-20">|</span>
						<span class="main-color">{{__('general.Blogs')}}</span>
					</div>
				</div>
			</div>
		</header>
		...
		<section class="blog-list-half section-padding" style="padding-bottom: 40px;">
			<div class="container">
				<div class="row">
...
<script>
	...
	new Vue({
		...
		methods: {
			getItems() {
				window.location.href = `/web/blogs?page=${this.page}&page_size=${this.page_size}`
			}
		}
	});
</script>
